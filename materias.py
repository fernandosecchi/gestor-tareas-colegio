...
predefinida de asignaturas comunes y permite al usuario seleccionar una de ellas
o ingresar una materia personalizada.

DEPENDENCIAS:
- utils.py: Necesita linea_separadora() para dibujar líneas decorativas en el menú
  de selección de materias

¿POR QUÉ ESTA DEPENDENCIA?
- utils.py centraliza todas las funciones de formato visual, incluyendo las líneas
  separadoras que mejoran la presentación del menú de materias
"""
