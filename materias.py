"""
MÓDULO DE MATERIAS - Con gestión dinámica
Catálogo de materias escolares disponibles

UTILIDAD:
Este archivo maneja el catálogo de materias escolares. Proporciona una lista
predefinida de asignaturas comunes, permite al usuario seleccionar una de ellas
o ingresar una materia personalizada. También incluye funciones para gestionar
el catálogo (agregar, editar, eliminar materias).

DEPENDENCIAS:
- utils.py: Necesita linea_separadora() y limpiar_pantalla() para la interfaz,
  y pausar() para detener el flujo después de operaciones

¿POR QUÉ ESTAS DEPENDENCIAS?
- utils.py centraliza todas las funciones de formato visual y control de flujo
"""

# Importa las funciones necesarias para la interfaz
from utils import linea_separadora, limpiar_pantalla, pausar
...
def mostrar_todas_las_materias():
...
def submenu_gestionar_materias():
    ...
    opciones = {
        "1": ("Ver catalogo completo", mostrar_todas_las_materias),
